namespace BionicAthlete.Training.Infrastructure.GarminFit.Decoding;
...
{
    private static readonly Assembly s_fitAssembly = typeof(Mesg).Assembly;
    private readonly GarminDeveloperFieldCatalog _developerFieldCatalog;
    ...
    public GarminFieldMapper(GarminDeveloperFieldCatalog developerFieldCatalog)
    {
        ...
        _developerFieldCatalog = developerFieldCatalog;
    }
    ...
    private static FitFieldSnapshot CreateStandardFieldSnapshot(Mesg mesg, FitNodeType nodeType, Field field)
    {
    ...
    private FitFieldSnapshot CreateDeveloperFieldSnapshot(Mesg mesg, FitNodeType nodeType, DeveloperField developerField)
    {
        GarminDeveloperFieldDescriptionMetadata? fieldDescription =
            _developerFieldCatalog.GetFieldDescription(developerField.DeveloperDataIndex, developerField.Num);

        GarminDeveloperDataIdentity? developerDataIdentity =
            fieldDescription?.DeveloperDataIdentity
            ?? _developerFieldCatalog.GetDeveloperDataIdentity(developerField.DeveloperDataIndex);
    ...
    private static bool TryConvertProfileEnum(string profileTypeName, object? normalizedRawValue, out string? enumName)
    {
        ...
        Type? enumType = s_fitAssembly.GetType($"Dynastream.Fit.{profileTypeName}", throwOnError: false, ignoreCase: false);
