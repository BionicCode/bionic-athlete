...
public interface IApplicationLogger<TService> : ILogger<TService>
{
    ...
    void LogInformationMessage(string message, [CallerMemberName] string? callerMemberName = null, [CallerLineNumber] int callerLineNumber = -1); void LogInformationObject(object obj, [CallerMemberName] string? callerMemberName = null, [CallerLineNumber] int callerLineNumber = -1);
