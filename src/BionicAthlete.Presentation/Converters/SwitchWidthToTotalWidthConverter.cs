...
internal class SwitchWidthToTotalWidthConverter : IMultiValueConverter
{
    ...
    public object Convert(object[] widthParameters,
      ...
      CultureInfo culture)
    {
        ArgumentNullExceptionAdvanced.ThrowIfNull(widthParameters);
        ArgumentNullExceptionAdvanced.ThrowIfNull(labelWidthParameter);
