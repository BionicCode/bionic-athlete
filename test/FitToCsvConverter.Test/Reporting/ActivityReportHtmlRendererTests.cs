namespace FitToCsvConverter.Test.Reporting;
...
public sealed class ActivityReportHtmlRendererTests
{
    ...
    {
        string outputDirectoryPath = Path.Combine(Path.GetTempPath(), "FitToCsvConverter.Test", Guid.NewGuid().ToString("N", CultureInfo.InvariantCulture));
